...
namespace BuildingBlocks.Core.Exception
{
    public static class GuardExtensions
    {
        ...
        public static string InvalidIpAddress(this IGuardClause guardClause, string ipString)
        {
            return guardClause.InvalidIpAddress(ipString, new InvalidIpAddressException(ipString));
        }
