...
namespace Order.Infrastructure.Shared.Extensions.WebApplicationExtensions
{
    public static partial class WebApplicationExtensions
    {
        public static async Task ApplyDatabaseMigrationsAsync(this WebApplication app)
        {
            ...
            if (configuration.GetValue<bool>("PostgresOptions:UseInMemory") == false)
            {
                ...
                app.Logger.LogInformation("Updating order database...");

                await locationDbContext.Database.MigrateAsync();

                app.Logger.LogInformation("Updated order database");
            }
        }
    }
}
