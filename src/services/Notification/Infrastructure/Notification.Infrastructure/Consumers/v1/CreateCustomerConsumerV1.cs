...
public class CreateCustomerConsumerV1 : IConsumer<CustomerCreatedV1>
{
    private readonly ICommandProcessor _commandProcessor;
    private readonly ILogger<CreateCustomerConsumerV1> _logger;
    private readonly IMessagePersistenceService _messagePersistenceService;

    public CreateCustomerConsumerV1(
        ICommandProcessor commandProcessor,
        ILogger<CreateCustomerConsumerV1> logger,
    ...
    public async Task Consume(ConsumeContext<CustomerCreatedV1> context)
    {
        _logger.LogInformation("Start to consuming create customer");
        ...
        _logger.LogInformation("End to consuming create customer");
    }
}