...
public sealed class ApplicationExceptionHandler : IExceptionHandler
{
    ...
    public ApplicationExceptionHandler( IServiceScopeFactory serviceScopeFactory)
    {
    ...
    {
        if (exception is not BuildingBlocks.Core.Domain.Exceptions.ApplicationException appException)
            return false;
        ...
        var problemDetails = new ExtensionProblemDetails()
        {
            ...
            StatusCode = appException.ErrorModel.StatusCode,
            ErrorList = [new ErrorList()
            {
                Message = appException.Message,
                        Code = appException.ErrorModel.ExceptionId
                    }]
        };
