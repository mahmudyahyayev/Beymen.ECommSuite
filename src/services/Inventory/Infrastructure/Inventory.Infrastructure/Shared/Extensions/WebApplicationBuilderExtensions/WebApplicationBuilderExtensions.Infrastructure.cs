...
using Inventory.Infrastructure.Publishers;
...
public static partial class WebApplicationBuilderExtensions
{
    public static WebApplicationBuilder AddInfrastructure(this WebApplicationBuilder builder)
    {
        ...
        {
            cfg.AddCreateOrderEndpointV1(context);
            cfg.AddCreateProductPublishV1();
            cfg.AddReservationConfirmedPublishV1();
            cfg.AddReservationCanceledPublishV1();
        });
